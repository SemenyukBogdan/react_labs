...
// import uaIcon from "../../icons/9153349_heart_love_country_nation_ukraine_icon.png"
import questionIcon from "../../icons/9042837_question_mark_circle_icon.png"
import './Header.css'
function Header() {
    return(
        <>
        <div className='container'>
            <header className="d-flex flex-wrap justify-content-center py-3 mb-3 ">
                ...
                <ul className="nav nav-pills">
                    ...
                    <div className="">
                        <a href="">
                        <img className="lang-icon" src="https://q-xx.bstatic.com/backend_static/common/flags/new/48-squared/us.png" alt="" role="presentation" loading="lazy"/>
                        </a>
                    </div>
                    </li>
                    <li className="nav-item navbar-icons">
                        <div className="">
                            <a href="">
                            <img src={questionIcon} className="rounded" alt="..."/>
                            </a>
                        </div>
                    </li>
                </ul>
